...
/*============== INFO OWNER ==============*/
global.sig = 'Clown_Store9'
global.syt = 'https://youtube.com/channel/UC0HU2GwK4gAmVLfpIf65ZMg'
global.sgh = 'https://github.com/hengker777'
...
/*============== WATERMARK ==============*/
global.wm = 'RIZZ-XD | By CLOWN STORE' //Main Watermark
global.wm2 = 'CLOWN STORE'
global.wm3 = 'RIZZ-XD | By CLOWN STORE'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `RIZZ-XD | ʙʏ ${global.nameown}`
...
global.botintro = 'Hallo, Kenalin saya RIZZ-XD BOT Saya akan membantu Anda kapan pun & Dimana pun, Saya asisten bot WhatsApp yang di buat oleh *CLOWN STORE* Saya di rilis pada tanggal\n🗓 ️_16/10/2022_'
